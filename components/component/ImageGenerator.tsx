  ...
  const HandleSubmit = async (e: FormEvent | null, randomindex = false) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setisLoading(false);
        setError("Дахиж оролдож үзнэ үү");
        return;
      }
    ...
    <div className="">
      <div className="flex flex-col mb-4  h-max  ">
        ...
        <div className=" flex  gap-4 items-center">
          <h1 className=" text-2xl "> Зураг хөрвүүлэгч</h1>
          <button
      ...
      >
        <div className=" flex flex-col w-full">
          <Input
            ...
            placeholder="Миний хүссэн зураг"
            required
        ...
        <Button type="submit" disabled={isLoading}>
          {isLoading ? (
            <div className="flex">
              <ReloadIcon className="mr-2 h-4 w-4 animate-spin" /> Хөрвүүлж байна
            </div>
          ) : (
            "Зураг хөрвүүлэх"
          )}
      ...
      {!URL && !isLoading ? (
        <div className=" w-full flex justify-center flex-col items-center mt-16">
          ...
          <h2 className=" text-xl md:text-2xl mx-auto font-serif flex gap-2 text-center">
            <LightBulb className=" w-6 h-6" /> Өөрийн зургийг бүтээх 
          </h2>
